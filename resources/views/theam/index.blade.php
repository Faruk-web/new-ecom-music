              ...
              <div class="row mv-block-style-2">
                <div class="swiper-container">
                  ...
                  <article class="col-xs-6 item item-filter-home-3 post swiper-slide">
                    ...
                    <div class="content-default">
                      <div class="content-price"><span class="new-price">{{$product->title}}</span></div>
                      <div class="content-desc"><a href="product-detail.html" title="Rev'it Cyclone Waterproof Jacket - Neon Yellow" class="mv-overflow-ellipsis">{{$product->short_descp}}</a></div>
                    </div>
                  </article>
                    <!-- .post-->
                    @endforeach
