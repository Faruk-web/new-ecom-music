	...
	<div class="container-fluid">
		<div class="card">
              <div class="card-header">
                <a href="{{ route('album.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Create Album</a>
              </div>
              <!-- /.card-header -->
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
	                  @foreach($categories as $category)
                        ...
                        <td><img src="{{ asset('images/album/'.$category->image ) }}" width="100"></td>
		                    <td>
		                    	<a href="{{ route('album.edit', $category->id) }}" class="btn btn-primary" title="Edit"><i class="fas fa-edit"></i></a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" align="right">
                                    <form action="{{ route('album.destroy', $category->id) }}" method="POST">
                                        @csrf
