  ...
  <div class="sidebar">
    ...
    <nav class="mt-2" id="sidebar">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item {{ in_array($routeName, ['product.index','album.index','music.index','event.index', 'product.create', 'category.index', 'brand.index', 'variation.index', 'attributes', 'tutorial.index']) ? 'menu-open' : '' }}">
          <a href="#" class="nav-link {{ in_array($routeName, ['product.index','album.index','music.index', 'product.create', 'category.index', 'brand.index', 'variation.index', 'attributes', 'tutorial.index']) ? 'active' : '' }}">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{ route('music.index') }}" class="nav-link {{ $routeName === 'music.index' ? 'active' : '' }}">
                <p>Music</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('event.index') }}" class="nav-link {{ $routeName === 'event.index' ? 'active' : '' }}">
                <p>Event</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('album.index') }}" class="nav-link {{ $routeName === 'album.index' ? 'active' : '' }}">
                <p>Album</p>
              </a>
            </li>
            <li class="nav-item">
