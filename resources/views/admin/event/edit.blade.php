                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="short_descp" name="short_descp" class="form-control @error('short_descp') is-invalid @enderror" placeholder="Description">{!! $event->short_descp !!}</textarea>
                            @error('long_descp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="long_descp" name="long_descp" class="form-control @error('long_descp') is-invalid @enderror" placeholder="Description">{!! $event->long_descp !!}</textarea>
                            @error('long_descp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                      ...
                      <div class="form-group col-md-12">
                              <div class="form-check form-check-inline ">
                                  <input class="form-check-input group1" id="is_active" type="checkbox" checked name="is_active" value="2" @if($event->is_active == 2) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="success" style="height: 50px; width: 30px" >
