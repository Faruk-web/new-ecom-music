                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-9">
                                        <div  class="form-check form-check-inline my-checkbox">
                                            <input class="form-check-input group1" id="wholesale" type="checkbox" name="accessories" value="1" value="1" style="height: 30px; width: 20px" {{$product->accessories == 1 ? 'checked' : ''}}>
                                            <label class="form-check-label" for="wholesale">Accessories</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="row">
                                    <div class="form-group col-md-9">
                                        <div class="form-check form-check-inline my-checkbox">
                                            <input class="form-check-input group1" id="noCrossCheck" type="checkbox" name="limited_edition" value="1" value="1" style="height: 30px; width: 20px" {{$product->limited_edition == 1 ? 'checked' : ''}}>
                                            <label class="form-check-label" for="noCrossCheck">Limited Edition</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
