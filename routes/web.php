...
Route::group(['prefix' => '/home', 'middleware' => ['auth', 'verified']], function(){
	...
	Route::group(['prefix' => 'category', 'as' => 'category.'], function(){
	 ...
	 Route::group(['prefix' => 'album', 'as' => 'album.'], function(){
		...
		Route::post('/stote', [AlbumController::class, 'store'])->name('store');
		Route::get('/edit/{id}', [AlbumController::class, 'edit'])->name('edit');
		Route::put('/update/{id}', [AlbumController::class, 'update'])->name('update');
		Route::PUT('admin/albums/{id}/media', [AlbumController::class, 'uploadMedia'])->name('uploadMedia');
		Route::post('/destroy/{id}', [AlbumController::class, 'destroy'])->name('destroy');
	});
	Route::get('/categories/{brand_id}', [AlbumController::class, 'getCategoriesByBrand']);
	 // Music Routes
	 Route::group(['prefix' => 'music', 'as' => 'music.'], function(){
		...
		Route::post('/stote', [MusicController::class, 'store'])->name('store');
		Route::get('/edit/{id}', [MusicController::class, 'edit'])->name('edit');
		Route::post('/update/{id}', [MusicController::class, 'update'])->name('update');
		Route::post('/destroy/{id}', [MusicController::class, 'destroy'])->name('destroy');
	});
	 // Music Routes
	 Route::group(['prefix' => 'event', 'as' => 'event.'], function(){
	    Route::get('/', [EventController::class, 'index'])->name('index');
	    Route::get('/create', [EventController::class, 'create'])->name('create');
		Route::post('/stote', [EventController::class, 'store'])->name('store');
	...
	Route::get('/categories/{brand_id}', [MusicController::class, 'getCategoriesByBrand']);
